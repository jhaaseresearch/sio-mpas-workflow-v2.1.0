  ...
  def __init__(self, config:Config, model:Model=None):
    ...
    if system == 'derecho':
      self.variablesWithDefaults['mpas bundle'] = \
        ['/glade/work/nghido/derecho/mpas_bundle_v2.1_aro_fix/build/', str]
       #   ['/glade/work/nghido/derecho/mpas_bundle_v2.1_aro_try1/build/', str]    
       # ['/glade/work/nystrom/Code/JEDI/jcsda_internal/mpas-bundle_2.1.0/', str]
#          ['/glade/work/nghido/derecho/mpas_bundle_v2.1_aro_fix/build/', str]
#          ['/glade/work/nystrom/Code/JEDI/jcsda_internal/gnu_build_2.1.0_derecho/', str]
    ...
    self._set('obs2iodaBuildDir', '/glade/work/nghido/derecho/obs2ioda/obs2ioda-v2/src')
