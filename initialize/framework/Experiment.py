...
class Experiment(Component):
  ...
  variablesWithDefaults = {
    ...
    #'user directory child': ['sio-cw3e_test/test_v2.1', str],
    #'user directory child': ['sio-cw3e_test/test_nystrom_bundle2.1', str],
    #'user directory child': ['sio-cw3e_test/test_v2.1_try1', str],
